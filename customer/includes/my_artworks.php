...
<div class="page-content fade-in-up">
    <div class="ibox rounded">
        <div class="ibox-body">
            <table style="overflow: auto;" class="table table-bordered table-hover table-responsive-lg" id="example-table" cellspacing="1" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($view_products as $view_product) {
                        ...
                        if ($status == "1") {
                            ...
                            $customer_id_custmer_table = $view_customer->customer_id;
                            if ($customer_id_custmer_table == $customer_id) {
                    ...
                    ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="../admin_area/product_images/<?php echo $product_img1; ?>" height="40px" width="60px"></td>
                                    ...
                                    <td>
                                        <a class="text-info" href="my_account.php?edit_my_artworks=<?php echo $product_id; ?>"><i class="fas fa-edit"></i> Edit</a>
                                    </td>
                                    <td>
