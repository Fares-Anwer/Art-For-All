                ...
                <form method="post" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col-12 mb-4">
                            ...
                            <input type="password" name="customer_pass" class="form-control p-3" id="password" placeholder="Enter Your Password" required oninput="validatePassword()">
                            <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 mb-3">
                            <button class="btn btn-info form-control py-2 font-weight-bold" name="login" type="submit" id="loginButton" disabled>
